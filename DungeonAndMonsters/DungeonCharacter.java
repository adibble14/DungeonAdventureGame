...
public abstract class DungeonCharacter {
	...
	/**
	 * Get method for minimum damage value
	 * @return access for min damage value
	 */
	//TODO Greyed out, use or remove!
	final protected int getMinDamage() {
		
		return this.myMinDamage;
	}
	
	/**
	 * Get method for accuracy value
	 * @return access for accuracy value
	 */
	//TODO Greyed out, use or remove!
	final protected double getAccuracy( ) {
	 ...
	 */
	final private boolean isAttack() {
