public class BossEncapsulation extends BossMonsters{
    /**
     ...
     * @param thePillar
     */
    protected BossEncapsulation(String theName, int theHealth, int theSpeed, int theMaxDamage, int theMinDamage, double theAccuracy, double theHealChance, int theMinHeal, int theMaxHeal, Pillar thePillar) {
